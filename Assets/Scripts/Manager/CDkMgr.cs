...
public class CDkMgr : BaseManager<CDkMgr>
{
    ...
    {
        物品列表 = new Dictionary<Prop_bascis, int>();
        物品列表.Add(pm.检索物品("(绝招)<三仙剑>"), 1);
        物品列表.Add(pm.检索物品("(绝招)<大荒拳>"), 1);
       if (pm.获取多个物品并显示特效(物品列表, "掉落"))
    ...
    private void VIP888()
    {
        物品列表 = new Dictionary<Prop_bascis, int>();
        物品列表.Add(pm.检索物品("灰色精华"), 100);
        物品列表.Add(pm.检索物品("绿色精华"), 100);
        物品列表.Add(pm.检索物品("蓝色精华"), 100);
        物品列表.Add(pm.检索物品("紫色精华"), 100);
        物品列表.Add(pm.检索物品("仙兽精华"), 100);
        物品列表.Add(pm.检索物品("灰色晶矿"), 1000);
        物品列表.Add(pm.检索物品("绿色晶矿"), 1000);
        物品列表.Add(pm.检索物品("蓝色晶矿"), 1000);
        物品列表.Add(pm.检索物品("紫色晶矿"), 1000);
        物品列表.Add(pm.检索物品("橙色晶矿"), 1000);
        物品列表.Add(pm.检索物品("红色晶矿"), 1000);
       if (pm.获取多个物品并显示特效(物品列表, "掉落"))
